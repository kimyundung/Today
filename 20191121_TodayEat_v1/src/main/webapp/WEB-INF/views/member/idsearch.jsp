...
<body>
	<div class="search_wrap">
		...
		<div class="search_form">
			...
			<form id="search" action="searchid" method="post">
				<input type="text" placeholder="이름" name="name" required="required" style="width:300px; height:50px; font-size:20px;"><br><br>
				<input type="email" placeholder="이메일" name="email" required="required" style="width:300px; height:50px; font-size:20px;"><br><br>
				<input type="submit" value="아이디 찾기"  style="width:300px; height:55px; font-size:25px; background-color:#0B6623;
